...
class DateConverter {
  ...
  static bool isAvailable(String starts, String ends, {DateTime? time}) {
    ...
    DateTime start = starts != null
        ? DateFormat('HH:mm').parse(starts)
        : DateTime(currentTime.year);
    DateTime end = ends != null
        ? DateFormat('HH:mm').parse(ends)
        : DateTime(
